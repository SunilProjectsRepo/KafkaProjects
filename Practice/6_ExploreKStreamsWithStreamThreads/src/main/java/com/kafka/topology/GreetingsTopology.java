...
public class GreetingsTopology {
    ...
    //Source Topic Name 1
    public static String GREETINGS = "greeting";
    //Source Topic Name 2
    public static String GREETINGS_SPANISH = "greeting-spanish";
    //Destination Topic Name
    public static String GREETINGS_CUSTOM_SERDE = "greeting-customserde";
